...
function getPixDate(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
    });
}
function GetTokenBradesco(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const token = yield pixBradescoFunctions.getPixToken();
...
function RegistraPix(req, res, params, authorization) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log(params);
...
function getPagamentoPixId(req, res, authorization, txid) {
    return __awaiter(this, void 0, void 0, function* () {
        //console.log(params)
        const instance2 = axiosPixBradescoFunctions.create({
            httpsAgent: new https.Agent({
...
function InsertWebhookPix(req, res, key, authorization) {
    return __awaiter(this, void 0, void 0, function* () {
        //console.log(params)
        const instance2 = axiosPixBradescoFunctions.create({
            httpsAgent: new https.Agent({
